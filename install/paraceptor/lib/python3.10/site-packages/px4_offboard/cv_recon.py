...
class CVReconControl(Node):
    def __init__(self, namespace):
        super().__init__('cv_recon_control')
...
def main(args=None):
    ...
    namespace = 'px4_3'
    cv_recon_control = CVReconControl(namespace=namespace)

    rclpy.spin(cv_recon_control)

    cv_recon_control.destroy_node()
    rclpy.shutdown()
